...
const About = () => {
  return (
    <div>
      ...
      low of $16,394.75. BTC has a capply of 19.24 M BTC and a max supply of 21
      M BTC.
      ...
      morbi sodales odio sed rhoncus. Diam praesent massa dapibus magna aliquam
      a dictumst volutpat. Egestas vitae pellentesque auctor amet. Nunc sagittis
      libero adipiscing cursus felis pellentesque interdum. Odio cursus
      phasellus velit in senectus enim dui. Turpis tristique placerat interdum
      sed volutpat, id imperdiet magna eget eros donec cursus nunc. Mauris
      ...
      convallis ultricies at. Fermentum hendrerit imperdiet nulla viverra
      ...
      lacinia congue ipsum fames amet dui. Purus ultrices tincidunt volutpat in
